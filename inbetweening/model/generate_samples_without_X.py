...
gap_sizes = [5]
save_folder_name = 'generated_samples_no_X'
path_to_checkpoint = '/proj/diffusion-inbetweening/inbetweening/model/lightning_logs/my_model_only_Q/version_0/checkpoints/epoch=2999-step=183000.ckpt'
